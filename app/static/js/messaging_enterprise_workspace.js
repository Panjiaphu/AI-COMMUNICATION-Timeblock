(function () {
  ...
  function syncLayoutMode() {
    ...
    const width = Number(window.innerWidth) > 0 ? window.innerWidth : layoutWidth;
    const compactLandscape = width <= 900 && window.innerHeight <= 500;
    const nextMode = width + 0.5 >= TWO_PANE_MIN && !compactLandscape ? "two" : "one";
